...
<html>
    ...
    <body class="skin-blue">
                        ...
                        <section class="col-lg-6 connectedSortable">
                            <div class="box box-info" >
                                <div class="box-header">
                                    <h1 class="box-title">Sobre Medi-Rec...</h1>
                                </div>
                                <p class="Para"> <h4>Medi-Rec ayudará a tener un mejor control de los medicamentos que se deben tomar. Su fácil uso permitirá tanto al usuario como a su doctor consultar un historial de las medicinas recetadas.</h4> </p>
                            </div>
                        </section><!-- /.Left col -->
                        <!-- right col (We are only adding the ID to make the widgets sortable)-->
                        <section class="col-lg-6 connectedSortable">
                            <div class="box box-info">
                                    <img src="img/med_1.png" class="img-responsive" alt="Medicinas">
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
      ...
      <c:choose> 
        <c:when test="${param.contraseña==param.contraseña2]">
        <sql:update var= "res" dataSource="&{con}">
    INSERT INTO Doctorsjdkdnksf]VALUE(?,?,?)
